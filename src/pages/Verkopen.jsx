...
export default function Verkopen({
  ...
  // ── Vinted Orders state — vtOrders/setVtOrders/vtLoading/vtError komen nu
  // als props binnen (zie useVintedOrdersSync-hook, 1x aangeroepen in
  // App.jsx zodat auto-registratie app-breed draait, niet enkel wanneer deze
  // pagina gemount wordt).
  ...
  const handleSaleModalSave = async (newSales) => {
  ...
  const visibleVtOrdersCount = useMemo(() => vtOrders.filter(o =>
  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <h1>Vinted verkopen</h1>
          <div className="page-subtitle">{visibleVtOrdersCount} Vinted-orders</div>
        </div>
      </div>
